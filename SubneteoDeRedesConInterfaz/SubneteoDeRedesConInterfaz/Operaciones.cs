...
namespace SubneteoDeRedesConInterfaz
{
    class Operaciones
    {
        ...
        private ArrayList NumeroHostSubred(string posible, string subredes, int hostLargo)
        {
            int a = 0;
        ...
        private int[] comprovarIPValida(string IPIniciarTexto, bool mascara)
        {
        ...
        private string CanversionBinario(int[] IP, int reyenar)
        {
            string IPBinario = "";
            string prebinario;
        ...
        private string[] subredesValido(string numeroSubredesTexto, string MascaraBinario, string IPBinario, bool redGeneral)
        {
        ...
        private string[] BinarioAArray(string hostBinario)
        {
            string[] Binario = { "", "", "", "" };
            int indice = 0;
            int counter = 0;
        ...
        private string[,] subneteo(string[] RedBinario, string[] hostBinario, string[] subredBinario, int numeroSubredes, bool redGeneral)
        {
        ...
        private string conversionesDeDatosFinales(string[] RedBinario, string[] hostBinario, bool PrimeraUltima, bool primera, bool ConCeros, int Indice, int numeroSubredes, bool RedGeneral)
        {
            // retorno
            string IPResult = "";
        ...
        private string[,] AñadirPuntosBinario(string[,] SinPuntos, int numSubredes, bool RedGeneral)
        {
        ...
        private string[,] IPDecimalConPuntos(string[,] BinarioConPuntos)
        {
        ...
        private string DeBinarioADecimalConPuntos(string[] separacion)
        {
            string resultado = "";
            int counter = 0;
        ...
        private int DeBinarioADecimal(string s)
        {
        ...
        // VLSM
        private string[,] SubneteoConVLSM(string[] RedBinario, string[] hostBinario, string[] subredBinario, int numeroSubredes, bool redGeneral, List<int> Host)
        {
            //Listas donde se guardan todos los resultados
            string[] IPRedRsult = new string[numeroSubredes];
            string[] IPBroadcastRsult = new string[numeroSubredes];
        ...
        private ArrayList conversionesDeDatosFinalesVLSM(string[] RedBinario, string[] hostBinario, bool PrimeraUltima, bool primera, bool ConCeros, int Indice, int numeroSubredes, bool PrimeraVez, string subredAnterior, int Host, bool segundaVez, int LongUltimaVez)
        {
            // retorno
            string IPResult = "";
        ...
        //Imprimir en consola
        private void Imprimir(string IP, int longRed, int longSubred)
        {
            int counter = 0;
            char Color = 'R';
        ...
        private void ImprimirGeneral(string IP, int longRed, int longSubred)
        {
            int counter = 0;
            char Color = 'R';
            foreach (char c in IP)
